    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="game-form">
                ...
                <h2 class="game-form-title">Add New Game to Collection</h2>
                ...
                <form action="{{ route('games.store') }}" method="POST">
                    ...
                    <div class="game-form-grid">
                        <div class="game-form-field">
                            ...
                            <input id="title" type="text" class="game-form-input" name="title" value="{{ old('title') }}" required autofocus>
                        </div>
                        
                        <div class="game-form-field">
                            <label for="image" class="game-form-label">Image URL</label>
                            <input id="image" type="text" class="game-form-input" name="image" value="{{ old('image') }}" required>
                        ...
                        <div class="game-form-field">
                            ...
                            <input id="genre" type="text" class="game-form-input" name="genre" value="{{ old('genre') }}" required>
                        </div>
                        
                        <div class="game-form-field">
                            <label for="release_year" class="game-form-label">Release Year</label>
                            <input id="release_year" type="number" min="1950" max="{{ date('Y') + 5 }}" class="game-form-input" name="release_year" value="{{ old('release_year', date('Y')) }}" required>
                        </div>
                        
                        <div class="game-form-field">
                            <label for="publisher" class="game-form-label">Publisher</label>
                            <input id="publisher" type="text" class="game-form-input" name="publisher" value="{{ old('publisher') }}">
                        </div>
                        
                        <div class="game-form-field full-width">
                            <label for="description" class="game-form-label">Description</label>
                            <textarea id="description" class="game-form-input game-form-textarea" name="description" rows="6" required>{{ old('description') }}</textarea>
                        </div>
                    </div>
